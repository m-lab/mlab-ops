...
slice_list = [
    ...
    Slice(name="northwestern_windrider", index=4, ipv6=['mlab4.nuq01']),
    Slice(name="uw_geoloc4",             index=5, ipv6=['mlab4.nuq01']),
    Slice(name="samknows_ispmon",        index=7, ipv6=['mlab4.nuq01']),
    Slice(name="gt_bismark",             index=8, ipv6=['mlab4.nuq01']),
    Slice(name="mlab_neubot",            index=9, ipv6=['mlab4.nuq01', 'mlab1.trn01']),
    Slice(name="michigan_1",             index=10, ipv6=['mlab4.nuq01']),
